    ...
    public function render($id) {
        ...
        <?php foreach($data as $key => $item): ?>
            ...
            >
                ...
                <span
                    data-copy-value="<?php echo esc_attr($item['permalink']); ?>"
                    class="dashicons dashicons-admin-page seopress-copy-clipboard"
                    style="padding:5px; background: var(--borderColorLight40); border-radius: 4px; width:30px; height:30px; display:flex; align-items:center; line-height:30px; justify-content:center; cursor:pointer;"
                ></span>
