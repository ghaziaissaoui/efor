...
if ('1' == seopress_rich_snippets_enable_option()) { //Is RS enable
    ...
    // Published date
    function seopress_rich_snippets_videos_date_posted_option($key_schema = 0) {
        $_seopress_pro_rich_snippets_videos_date_posted = seopress_get_pro_rich_snippets_by_key(get_the_ID(), '_seopress_pro_rich_snippets_videos_date_posted', $key_schema);
        if ('' != $_seopress_pro_rich_snippets_videos_date_posted) {
            return $_seopress_pro_rich_snippets_videos_date_posted;
        } else { //Default
    ...
    function seopress_rich_snippets_videos_option($key_schema = 0) {
        ...
        if(!empty(seopress_rich_snippets_videos_date_posted_option())){
            $html .= '"uploadDate": "' . seopress_rich_snippets_videos_date_posted_option() . '",';
        }
