...
function seopress_get_rich_snippets_fallback($post) {
    return [
        ...
        '_seopress_pro_rich_snippets_jobs_location_requirement' => get_post_meta($post->ID, '_seopress_pro_rich_snippets_jobs_location_requirement', true),
...
function seopress_update_rich_snippets_fallback($post_id) {
    ...
    if (isset($_POST['seopress_pro_rich_snippets_jobs_location_requirement'])) {
        update_post_meta($post_id, '_seopress_pro_rich_snippets_jobs_location_requirement', esc_html($_POST['seopress_pro_rich_snippets_jobs_location_requirement']));
    }
    //Video
    ...
    if (isset($_POST['seopress_pro_rich_snippets_videos_date_posted'])) {
        update_post_meta($post_id, '_seopress_pro_rich_snippets_videos_date_posted', esc_textarea($_POST['seopress_pro_rich_snippets_videos_date_posted']));
    }
