...
function seopress_google_analytics_matomo_widget_auth_token_callback() {
    ...
    printf('<input type="password" name="seopress_google_analytics_option_name[seopress_google_analytics_matomo_widget_auth_token]" value="%s" aria-label="' . __('Matomo authentication token', 'wp-seopress-pro') . '"/>', esc_html($check));
}
